...
sealed trait DeclarationDate

object DeclarationDate extends Enumerable.Implicits {

  case object AllAvailableData extends WithName("allAvailableData") with DeclarationDate
