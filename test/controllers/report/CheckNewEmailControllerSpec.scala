...
import pages.report.CheckNewEmailPage
import play.api.inject.bind
import play.api.mvc.Call
import play.api.test.FakeRequest
import play.api.test.Helpers.*
import repositories.SessionRepository
import views.html.CheckNewEmailView
...
class CheckNewEmailControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val checkNewEmailRoute = routes.CheckNewEmailController.onPageLoad(NormalMode).url
  ...
  "CheckNewEmail Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(CheckNewEmailPage, true).success.value
