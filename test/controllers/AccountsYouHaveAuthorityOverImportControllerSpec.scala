...
import pages.AccountsYouHaveAuthorityOverImportPage
import play.api.inject.bind
import play.api.mvc.Call
import play.api.test.FakeRequest
import play.api.test.Helpers._
import repositories.SessionRepository
import views.html.AccountsYouHaveAuthorityOverImportView
...
class AccountsYouHaveAuthorityOverImportControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val accountsYouHaveAuthorityOverImportRoute = routes.AccountsYouHaveAuthorityOverImportController.onPageLoad(NormalMode).url
