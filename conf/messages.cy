...
customRequestStartDate.singleReport.title = cy: Which date do you want your report to start?
customRequestStartDate.pluralReport.title = cy: Which date do you want your reports to start?
customRequestStartDate.singleReport.heading = cy: Which date do you want your report to start?
customRequestStartDate.pluralReport.heading = cy: Which date do you want your reports to start?
customRequestStartDate.message1 = cy: You can request up to 31 days of data, starting from any date within the last 4 years.
...
customRequestStartDate.error.max = cy: The start date must be today or in the past
...
customRequestEndDate.singleReport.title = cy: Which date do you want your report to end?
customRequestEndDate.pluralReport.title = cy: Which date do you want your reports to end?
customRequestEndDate.singleReport.heading = cy: Which date do you want your report to end?
customRequestEndDate.pluralReport.heading = cy: Which date do you want your reports to end?
customRequestEndDate.hint = cy: For example, {0}.
customRequestEndDate.message1 = cy: You entered a start date of {0}. You can request up to 31 days of data from this date.
...
customRequestEndDate.error.afterToday = cy: The end date must be today or in the past
