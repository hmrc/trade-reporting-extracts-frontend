...
reportTypeImport.message = cy: A separate file is created for each type of report.
...
availableReports.message1 = cy: You can download reports until their expiry date, shown in the table.
